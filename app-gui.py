...
class StartPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            button1 = tk.Button(self, text="  Recogniton ", fg="#ffffff", bg="#263942",command=lambda: self.controller.show_frame("PageOne"))
            button2 = tk.Button(self, text="  Detection  ", fg="#ffffff", bg="#263942",command=lambda: self.controller.show_frame("PageTwo"))
